...
* @see https://v0.dev/t/Ao6Cmx8JOYB
      ...
      <section className="bg-primary py-20 md:py-32">
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-4">
            <h1 className="text-3xl font-bold text-primary-foreground sm:text-4xl md:text-5xl">Get in Touch</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-medium">CARTX Headquarters</p>
